...
public class CountryListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            item.setCheckMark((ImageView) itemView.findViewById(R.id.ivCheckMark));
        ...
        if(country.getSelectedIsoCode())
        {
            item.getCheckMark().setVisibility(View.VISIBLE);
        }
        else
        {
            item.getCheckMark().setVisibility(View.INVISIBLE);
        }
    ...
    public static class Item {
        ...
        public ImageView getCheckMark(){ return checkMark; }

        public void setCheckMark(ImageView checkMark){ this.checkMark = checkMark; }
    }
}
